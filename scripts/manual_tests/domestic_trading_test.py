...
functions_path = os.path.join(current_dir, 'kis_resources', 'examples_user', 'domestic_stock')
sys.path.append(functions_path)
sys.path.append(os.path.join(current_dir, 'kis_resources', 'examples_user'))
